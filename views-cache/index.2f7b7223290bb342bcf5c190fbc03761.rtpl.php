<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="desktop-menu menu-side-w menu-activated-on-click">
    <div class="logo-w">
      <a class="logo" href="index.html"><img src="../site/resources/img/logo.png"><span>TotClean</span></a>
    </div>
    <div class="menu-and-user">
      <div class="logged-user-w">
        <div class="avatar-w">
          <img alt="" src="../site/resources/img/avatar1.jpg">
        </div>
