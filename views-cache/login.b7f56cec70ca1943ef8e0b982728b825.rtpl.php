...
<html>
  <head>
    <title>TotClean Admin Login</title>
    <meta charset="utf-8">
  ...
  <body class="auth-wrapper">
    <div class="all-wrapper menu-side with-pattern">
      <div class="auth-box-w">
        <div class="logo-w">
          <a href="/Totclean/admin/login"><img alt="" src="/Totclean/site/resources/img/logo-big.png"></a>
        </div>
        <h4 class="auth-header">
          Totclean
        </h4>
        <form action="/Totclean/admin/login" method="post">
          <div class="form-group">
            <label for="">ID</label><input name="login" class="form-control" placeholder="Digite seu id" type="text" maxlength="11" required>
            <div class="pre-icon os-icon os-icon-user-male-circle"></div>
          </div>
          <div class="form-group">
            <label for="">Senha</label><input name="password" class="form-control" placeholder="Digite sua senha" type="password" maxlength="11" required>
